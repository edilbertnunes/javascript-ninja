...
var sum = function calculateSum(x,y) {
  return x + y;
}; // o ; é obrigatório pq vc está atribuindo uma função a uma variável
...
*/
var varShowName = showName; // não é pra invocar/executar a funcao showName()
